...
internal sealed class Manifold
{
    ...
    public Manifold(IPEndPoint endPoint, ushort pump, IReadOnlyDictionary<string, IEnumerable<ushort>> rooms)
    {
        ...
        Relays = rooms
            ...
            .ToFrozenDictionary(group => group.Key, group => new CompoundRelay(group) as IRelay);
    }

    public IRelay Pump { get; }

    public IReadOnlyDictionary<string, IRelay> Relays { get; }
    ...
    private sealed class ManifoldRelay(Manifold manifold, ushort index) : IRelay
    {
