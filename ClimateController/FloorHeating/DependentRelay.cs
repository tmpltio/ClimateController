...
internal sealed class DependentRelay(IRelay relay)
{
    ...
    private sealed class SignalingRelay(DependentRelay dependentRelay, IRelay relay) : IRelay
    {
