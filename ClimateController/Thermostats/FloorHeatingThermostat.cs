...
internal sealed class FloorHeatingThermostat : Thermostat
{
    ...
    private FloorHeatingThermostat(TemperatureSensor temperatureSensor, HumiditySensor humiditySensor, Relay heatingLoop)
    {
    ...
    public static async Task<Thermostat> CreateAsync(TemperatureSensor temperatureSensor, HumiditySensor humiditySensor, Relay heatingLoop, CancellationToken cancellationToken = default)
    {
